...
function extractJson(text: string) {
  ...
  throw new Error("LLMの出力からJSONを抽出できませんでした。");
}

export async function generateLearningPointCandidatesWithLLM({
  topic,
  subtopic,
  keywords,
  count = 5,
...
与えられた分野・キーワードから、専門医試験で問う価値のある learning point 候補を作成してください。
